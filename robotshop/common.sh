...
NODEJS(){
  ...
  cd /home/roboshop && unzip -o /tmp/${COMPONENT}.zip &>>$LOG
  STAT_CHECK $?
  ...
  sed -i -e "s/MONGO_DNSNAME/mongodb.robotshop.internal/" -e "s/REDIS_ENDPOINT/redis.robotshop.internal/" -e "s/MONGO_ENDPOINT/mongo.robotshop.internal/"  /etc/systemd/system/${COMPONENT}.service
  STAT_CHECK $?
